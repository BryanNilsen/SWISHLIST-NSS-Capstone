  ...
  handleLogin = e => {
    if (this.state.loginEmail === "" || this.state.loginPassword === "") {
      ...
      APIManager.userLogin(
        ...
        this.props.setCurrentUserState(decoded.sub);
      });
      // //
      ...
      //   if (returns.length < 1) {
      //     alert(
      //       "That email doesn't exist or your password doesn't match. Please try again"
      //     );
  ...
  render() {
    return (
      <React.Fragment>
        <div
          className={
            this.props.hideLoginForm ? "hide" : "center basketball_bkg"
          }
        >
          <br />
          <br />
          <div className="login_form">
            ...
            <label className="form_label" htmlFor="loginEmail">
              Email
            </label>
            <input
            ...
            />
            <br />
            <label className="form_label" htmlFor="loginPassword">
              Password
            </label>
            <input
              className="form_input"
